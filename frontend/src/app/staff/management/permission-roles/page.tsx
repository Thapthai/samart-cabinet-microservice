...
// Flatten staffMenuItems (and submenus) from menus.ts for permission table. Dedupe by href so the same path (e.g. parent + sub both /staff/items) appears only once.
