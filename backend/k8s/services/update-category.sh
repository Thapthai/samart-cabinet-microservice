...
# ============================================
# 🔄 Backend - Update Category Service
# ============================================
# ใช้สำหรับ: อัพเดท Category Service
# ============================================
...
# Configuration
IMAGE_NAME="backend-category-service:latest"
NAMESPACE="pose-microservices"
DEPLOYMENT_NAME="category-service"

echo -e "${BLUE}╔════════════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║  🔄 UPDATE SERVICE - Category Service            ║${NC}"
echo -e "${BLUE}╚════════════════════════════════════════════════════╝${NC}"
echo ""
...
cd ../..
docker build -f docker/Dockerfile.category -t ${IMAGE_NAME} .
...
docker images | grep backend-category-service
...
sudo k3s ctr images ls | grep backend-category-service
...
# Success Message
echo -e "${GREEN}╔════════════════════════════════════════════════════╗${NC}"
echo -e "${GREEN}║  ✅ Category Service Update Completed!            ║${NC}"
echo -e "${GREEN}╚════════════════════════════════════════════════════╝${NC}"
echo ""
