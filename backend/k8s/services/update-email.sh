...
# ============================================
# 🔄 Backend - Update Email Service
# ============================================
# ใช้สำหรับ: อัพเดท Email Service
# ============================================
...
# Configuration
IMAGE_NAME="backend-email-service:latest"
NAMESPACE="pose-microservices"
DEPLOYMENT_NAME="email-service"

echo -e "${BLUE}╔════════════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║  🔄 UPDATE SERVICE - Email Service               ║${NC}"
echo -e "${BLUE}╚════════════════════════════════════════════════════╝${NC}"
echo ""
...
cd ../..
docker build -f docker/Dockerfile.email -t ${IMAGE_NAME} .
...
docker images | grep backend-email-service
...
sudo k3s ctr images ls | grep backend-email-service
...
# Success Message
echo -e "${GREEN}╔════════════════════════════════════════════════════╗${NC}"
echo -e "${GREEN}║  ✅ Email Service Update Completed Successfully!  ║${NC}"
echo -e "${GREEN}╚════════════════════════════════════════════════════╝${NC}"
echo ""
