...
# ============================================
# 🔄 Backend - Update Auth Service
# ============================================
# ใช้สำหรับ: อัพเดท Auth Service
# ============================================
...
# Configuration
IMAGE_NAME="backend-auth-service:latest"
NAMESPACE="pose-microservices"
DEPLOYMENT_NAME="auth-service"

echo -e "${BLUE}╔════════════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║  🔄 UPDATE SERVICE - Auth Service                ║${NC}"
echo -e "${BLUE}╚════════════════════════════════════════════════════╝${NC}"
echo ""
...
cd ../..
docker build -f docker/Dockerfile.auth -t ${IMAGE_NAME} .
...
docker images | grep backend-auth-service
...
# Success Message
echo -e "${GREEN}╔════════════════════════════════════════════════════╗${NC}"
echo -e "${GREEN}║  ✅ Auth Service Update Completed Successfully!   ║${NC}"
echo -e "${GREEN}╚════════════════════════════════════════════════════╝${NC}"
echo ""
