...
# ============================================
# 🔄 Backend - Update Item Service
# ============================================
# ใช้สำหรับ: อัพเดท Item Service
# ============================================
...
# Configuration
IMAGE_NAME="backend-item-service:latest"
NAMESPACE="pose-microservices"
DEPLOYMENT_NAME="item-service"

echo -e "${BLUE}╔════════════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║  🔄 UPDATE SERVICE - Item Service                ║${NC}"
echo -e "${BLUE}╚════════════════════════════════════════════════════╝${NC}"
echo ""
...
cd ../..
docker build -f docker/Dockerfile.item -t ${IMAGE_NAME} .
...
docker images | grep backend-item-service
...
sudo k3s ctr images ls | grep backend-item-service
...
# Success Message
echo -e "${GREEN}╔════════════════════════════════════════════════════╗${NC}"
echo -e "${GREEN}║  ✅ Item Service Update Completed Successfully!   ║${NC}"
echo -e "${GREEN}╚════════════════════════════════════════════════════╝${NC}"
echo ""
